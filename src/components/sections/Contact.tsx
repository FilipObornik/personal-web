...
import { Send, Mail, Calendar, ArrowRight, CheckCircle2, Linkedin } from "lucide-react";
    ...
    <section id="kontakt" className="section-padding bg-secondary relative overflow-hidden">
      ...
      <div className="container-narrow mx-auto relative">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 lg:gap-12">
          ...
          {/* Right side - Contact info & Calendar */}
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
          ...
          >
            ...
            {/* Calendar booking */}
            <div className="bg-primary rounded-2xl md:rounded-3xl p-6 md:p-8 relative overflow-hidden">
              {/* Decorative circles */}
              ...
              <div className="relative">
                ...
                <p className="text-secondary/70 text-sm mb-6">
                  Vyberte si termín pro 30minutový úvodní hovor zdarma.
                </p>
                <a
                  href="#"
                  className="inline-flex items-center gap-2 bg-secondary text-white px-6 py-3 rounded-xl font-semibold hover:bg-secondary-light transition-colors"
                >
                  Vybrat termín
                  <ArrowRight size={16} />
                </a>
