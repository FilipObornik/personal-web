...
export default function Hero() {
  ...
  return (
    <section
      id="hero"
      className="min-h-[700px] relative overflow-hidden bg-secondary px-4 md:px-8"
    >
      ...
      <div className="container-narrow mx-auto pt-0 pb-40 md:pt-40 md:pb-56 relative z-10">
